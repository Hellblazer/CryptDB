 ...
 */
template <class T, typename Compare, typename Distance>
AvlTree<T,Compare, Distance>::AvlTree( const AvlTree<T,Compare,
                                                     Distance> & rhs ) :
    root( NULL )
{
    *this = rhs;
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::insert( const T & x )
{
    ...
    // Whether the node was successfully inserted or not (i.e. wasn't a
    // duplicate)
    //
    return retVal;
}
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::remove( const T & x )
{
    ...
    if ( currNode )
    {
        ...
        else
        {
            ...
            // Remove the child and reconnect the smallest node in the right
            // sub tree
            // (in order successor)
            //
            AvlNode<T,Compare, Distance>* replaceNode = findMin(
                currNode->right);
            ...
            if ( !replaceNode )
            {
                // Get the largest node on the left (because the right doesn't
                // exist)
                //
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::findMin( ) const
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::findMax( ) const
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::rootElement() const
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare, Distance>::rootElementPtr() const
{
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::prevElement( const T& x ) const
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::nextElement( const T& x ) const
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare, Distance>::prevElementPtr( const T& x ) const
{
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare, Distance>::nextElementPtr( const T& x ) const
{
...
AvlTree<T,Compare, Distance>::find( const T & x ) const
{
    return find(x, root);
}
...
template <class T, typename Compare, typename Distance>
T&
AvlTree<T,Compare, Distance>::find( const T & x )
throw (NotFound)
{
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::findClosest( const T & x ) const
{
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare,Distance>::leftElementPtr( const T & x) const
{
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare,Distance>::rightElementPtr( const T & x) const
{
    AvlNode<T, Compare, Distance>* retVal = find(x);
...
template <class T, typename Compare, typename Distance>
const T* const
AvlTree<T, Compare, Distance>::closestLeftOf(const T& x) const
{
...
template <class T, typename Compare, typename Distance>
const T* const
AvlTree<T, Compare, Distance>::closestRightOf(const T& x) const
{
    AvlNode<T, Compare, Distance>* retVal = findClosest(x);
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::prev( const T & x ) const
{
    return prev(find(x));
}
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::next( const T & x ) const
{
    return next(find(x));
}
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::prev( AvlNode<T,Compare, Distance>* t ) const
{
    if ( t )
    {
        ...
        else if ( t->parent )
        {
            ...
            if ( t->isLeft() )
            {
                // We're on the left side of our parent, which means the
                // parent
                // is greater than us. So we need to find our parent's
                // sequential
                // previous element.
                //
                // We disconnect ourselves momentarily to allow this operation
                // to
                // ignore this branch
                //
            ...
            {
                // We're on the right side of our parent and we don't have a
                // left
                // child, this must mean that our parent is the previous
                // sequential
                // element in the tree.
                //
                // If we're the root node, then the parent is naturally NULL
                // so the
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::next( AvlNode<T,Compare, Distance>* t ) const
{
    if ( t )
    {
        ...
        else if ( t->parent )
        {
            ...
            if ( t->isLeft() )
            {
                // We're on the right side of our parent and we don't have a
                // right
                // child, this must mean that our parent is the next
                // sequential
                // element in the tree.
                //
                // If we're the root node, then the parent is naturally NULL
            ...
            {
                // We're on the right side of our parent, which means the
                // parent
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::makeEmpty( )
{
    makeEmpty( root );
}
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::isEmpty( ) const
{
    return root == NULL;
}
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::printTree( ostream& out ) const
{
    if( isEmpty( ) )
    {
        out << "Empty tree" << endl;
...
template <class T, typename Compare, typename Distance>
int
AvlTree<T,Compare, Distance>::height() const
{
    return root->height();
}
...
template <class T, typename Compare, typename Distance>
const T &
AvlTree<T,Compare, Distance>::elementAt( const AvlNode<T,Compare,
                                                       Distance> *t ) const
throw (NotFound)
{
    if( t == NULL )
...
template <class T, typename Compare, typename Distance>
const T * const
AvlTree<T,Compare, Distance>::elementPtrAt( const AvlNode<T,Compare,
                                                          Distance> *t )
const
{
    if( t == NULL )
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::insert( const T & x, AvlNode<T,Compare,
                                                           Distance> * & t )
{
    if ( t == NULL )
    {
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::merge( const AvlTree<T,Compare,Distance>& b )
{
...
bool
AvlTree<T,Compare,
        Distance>::merge( AvlNode<T,Compare,Distance>* b, AvlNode<T,Compare,
                                                                  Distance> *
                          & t )
{
    if ( !b )
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::balanceTree(AvlNode<T,Compare, Distance>* &node)
{
    if ( node )
    {
...
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare,
        Distance>::findMin( AvlNode<T,Compare, Distance> *t ) const
{
    if( t == NULL)
    {
        return t;
...
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare,
        Distance>::findMax( AvlNode<T,Compare, Distance> *t ) const
{
    if( t == NULL )
    {
        return t;
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::find( const T & x, AvlNode<T,Compare,
                                                         Distance> *t ) const
{
    while( t != NULL )
    {
...
template <class T, typename Compare, typename Distance>
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare, Distance>::findClosest( const T & x, AvlNode<T,Compare,
                                                                Distance> *t )
const
{
    // Save the parent
    ...
    while( t != NULL )
    {
        ...
        if ( fabs(parentDistance) < fabs(leftDistance) &&
             fabs(parentDistance) < fabs(rightDistance) )
        {
...
void
AvlTree<T,Compare,
        Distance>::makeEmpty( AvlNode<T,Compare, Distance> * & t ) const
{
    if( t != NULL )
    {
        makeEmpty( t->left );
...
AvlNode<T,Compare, Distance> *
AvlTree<T,Compare,
        Distance>::clone( const AvlNode<T,Compare, Distance> * t ) const
{
    if( t == NULL )
    {
        return NULL;
    ...
    {
        // Create a node with the left and right nodes and a parent set to
        // NULL
        //
        AvlNode<T,Compare,Distance>* retVal = new AvlNode<T,Compare, Distance>(
            t->element, NULL, clone( t->left ), clone( t->right ) );
...
template <class T, typename Compare, typename Distance>
int
AvlTree<T,Compare, Distance>::height( AvlNode<T,Compare, Distance> *t ) const
{
...
template <class T, typename Compare, typename Distance>
int
AvlTree<T,Compare, Distance>::max( int lhs, int rhs ) const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::rotateWithLeftChild( AvlNode<T,Compare,
                                                           Distance> * & k2 )
const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::rotateWithRightChild( AvlNode<T,Compare,
                                                            Distance> * & k1 )
const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::doubleWithLeftChild( AvlNode<T,Compare,
                                                           Distance> * & k3 )
const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::doubleWithRightChild( AvlNode<T,Compare,
                                                            Distance> * & k1 )
const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::printTree( ostream& out,
                                         AvlNode<T,Compare,
                                                 Distance> *t, int numTabs,
                                         char lr ) const
{
    if( t != NULL )
    {
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::sanityCheck() const
{
...
template <class T, typename Compare, typename Distance>
bool
AvlTree<T,Compare, Distance>::sanityCheck(AvlNode<T,Compare,
                                                  Distance>* const &node)
const
{
    if ( !node )
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::removeNode(AvlNode<T,Compare, Distance>* &node)
{
...
void
AvlTree<T,Compare,
        Distance>::replaceNode(AvlNode<T,Compare,
                                       Distance>* &node1, AvlNode<T,Compare,
                                                                  Distance>
                               * &node2)
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::getAllElements(vector<T*>& elements,
                                             bool copy) const
{
...
// Adds all ancestors to a given vector. Adds copies or the internal
// references depending on the flag
//
// O(log n)
//
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare, Distance>::getAllAncestors(vector<T*>& ancestors,
                                              const T& x,
                                              bool copy) const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare,Distance>::rangeQuery(vector<T*>& range, const T& min,
                                        const T& max,
                                        bool copy) const
{
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare,Distance>::rangeQuery(vector<T*>& range,
                                        AvlNode<T,Compare,
                                                Distance>* b, const T& min,
                                        const T& max,
                                        bool copy) const
{
    // Find the split node
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare,Distance>::rangeQuery(RangeQueryCallback cb, const T& min,
                                        const T& max,
                                        void* arg) const
{
    // Only do something if it makes sense
...
template <class T, typename Compare, typename Distance>
void
AvlTree<T,Compare,Distance>::rangeQuery(RangeQueryCallback cb,
                                        AvlNode<T,Compare,
                                                Distance>* b, const T& min,
                                        const T& max,
                                        void* arg) const
...
template <class T, typename Compare, typename Distance>
bool
AvlNode<T,Compare, Distance>::isLeft()
{
    // It is a leaf, simply remove the item and disconnect the parent
    //
...
template <class T, typename Compare, typename Distance>
void
AvlNode<T,Compare, Distance>::setParent(AvlNode<T,Compare, Distance>* p)
{
    // Set our new parent
    //
    parent = p;
...
template <class T, typename Compare, typename Distance>
void
AvlNode<T,Compare, Distance>::setLeft(AvlNode<T,Compare, Distance>* l)
{
...
template <class T, typename Compare, typename Distance>
void
AvlNode<T,Compare, Distance>::setRight(AvlNode<T,Compare, Distance>* r)
{
...
template <class T, typename Compare, typename Distance>
void
AvlNode<T,Compare,Distance>::calcHeights()
{
...
template <class T, typename Compare, typename Distance>
int
AvlNode<T,Compare, Distance>::height() const
{
    // The height is equal to the maximum of the right or left side's height
    // plus 1
    //
    // This can be done very inefficiently as in O(n) with the following line:
    //
    //  return max(left ? left->height() : 0, right ? right->height() : 0) +
    // 1;
    //
    return _height;
}
...
template <class T, typename Compare, typename Distance>
int
AvlNode<T,Compare, Distance>::balanceFactor() const
{
