...
CREATE TABLE phpbb_privmsgs (
	...
	message_edit_reason encfor msg_id varchar(255),
	message_edit_user encfor msg_id mediumint(8) DEFAULT '0',
	message_attachment encfor msg_id tinyint(1) DEFAULT '0' NOT NULL,
	bbcode_bitfield varchar(255) DEFAULT '' NOT NULL,
	bbcode_uid varchar(8) DEFAULT '' NOT NULL,
	message_edit_time encfor msg_id int(11) UNSIGNED DEFAULT '0',
	message_edit_count encfor msg_id smallint(4) UNSIGNED DEFAULT '0',
	to_address encfor msg_id text NOT NULL,
	bcc_address encfor msg_id text NOT NULL,
	message_reported encfor msg_id tinyint(1),
	PRIMARY KEY (msg_id),
