...
CREATE TABLE phpbb_acl_groups (
	group_id hasaccessto forum_id if groupaccess(auth_option_id, auth_role_id) mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_forums (
	...
	forum_name encfor forum_id varchar(255) DEFAULT '' NOT NULL,
	...
	forum_image encfor forum_id varchar(255) DEFAULT '' NOT NULL,
	...
	forum_posts encfor forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	forum_topics encfor forum_id HOM mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	...
	forum_last_post_subject encfor forum_id varchar(255) DEFAULT '' NOT NULL,
	forum_last_post_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
	forum_last_poster_name encfor forum_id varchar(255) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_posts (
	...
	post_time encfor forum_id OPE int(11) UNSIGNED DEFAULT '0' NOT NULL,
	...
	post_subject encfor forum_id varchar(255) DEFAULT '' NOT NULL COLLATE utf8_unicode_ci,
	post_text encfor forum_id mediumtext NOT NULL,
	post_checksum varchar(32) DEFAULT '' NOT NULL,
	post_attachment encfor forum_id tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	bbcode_bitfield varchar(255) DEFAULT '' NOT NULL,
	bbcode_uid varchar(8) DEFAULT '' NOT NULL,
	post_postcount tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	post_edit_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
	post_edit_reason encfor forum_id varchar(255) DEFAULT '' NOT NULL,
	post_edit_user encfor forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	post_edit_count encfor forum_id  smallint(4) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_privmsgs (
	...
	message_time encfor msg_id OPE int(11) UNSIGNED DEFAULT '0' NOT NULL,
	enable_bbcode tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_smilies tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_magic_url tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_sig tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	message_subject encfor msg_id varchar(255) DEFAULT '' NOT NULL,
	message_text encfor msg_id mediumtext NOT NULL,
	message_edit_reason encfor msg_id varchar(255) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_privmsgs_to (
	...
	user_id hasaccessto msg_id equals phpbb_users.user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	...
	pm_new encfor msg_id tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
