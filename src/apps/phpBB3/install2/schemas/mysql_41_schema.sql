...
CREATE TABLE phpbb_forums (
	...
	forum_topics encfor forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	...
	forum_last_post_subject encfor forum_id varchar(255) NOT NULL,
	forum_last_post_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
	forum_last_poster_name encfor forum_id varchar(255) NOT NULL,
...
CREATE TABLE phpbb_posts (
	...
	post_time encfor forum_id int(11) UNSIGNED DEFAULT '0' NOT NULL,
	...
	post_edit_reason encfor forum_id varchar(255) NOT NULL,
...
CREATE TABLE phpbb_privmsgs (
	...
	message_time encfor msg_id int(11) UNSIGNED DEFAULT '0' NOT NULL,
	enable_bbcode tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_smilies tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_magic_url tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	enable_sig tinyint(1) UNSIGNED DEFAULT '1' NOT NULL,
	message_subject encfor msg_id varchar(255) NOT NULL,
...
CREATE TABLE phpbb_users (
	user_id equals phpbb_privmsgs.user_id  mediumint(8) UNSIGNED NOT NULL auto_increment,
